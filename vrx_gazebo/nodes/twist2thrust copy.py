...
class Node():
    ...
    def callback(self,data):
        ...
        rospy.loginfo("\t\tx: {:.2f}, y: {:.2f}, z: {:.2f}".format(data.linear.x, data.linear.y, data.linear.z))
        rospy.loginfo("\tangular:")
        rospy.loginfo("\t\tx: {:.2f}, y: {:.2f}, z: {:.2f}".format(data.angular.x, data.angular.y, data.angular.z))
